package com.gaur.matchbox.all_matches.adapter
...
class AllMatchesAdapter(
...
) : RecyclerView.Adapter<AllMatchesAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): AllMatchesAdapter.MyViewHolder {
        val binding =
            ViewHolderMatchBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return MyViewHolder(binding)
    }

    override fun onBindViewHolder(holder: AllMatchesAdapter.MyViewHolder, position: Int) {
